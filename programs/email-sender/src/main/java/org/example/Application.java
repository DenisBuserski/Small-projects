...
//        String recipient = "denis.buserski@gmail.com";
        ...
        switch (task) {
            case "1":
                ...
                Message message1 = EmailPreparation.prepareMessage(session, result, "1");
                EmailPreparation.sendMessage(session, message1);
                break;
            case "2":
                ...
                Message message2 = EmailPreparation.prepareMessage(session, result, "2");
                EmailPreparation.sendMessage(session, message2);
                break;
            default:
